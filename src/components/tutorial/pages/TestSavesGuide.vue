...
export default {
    ...
    methods:{
        prepareSubtitles(){
            this.subtitles = [
                { title: 'Что такое экземпляр теста', mark: 'p6-st-1' },
                { title: 'Создание экземпляра теста', mark: 'p6-st-2' },
                { title: 'Список экземпляра теста', mark: 'p6-st-3' },
                { title: 'Использование экземпляра теста', mark: 'p6-st-4' },
                { title: 'Удаление экземпляра теста', mark: 'p6-st-5' }
            ]
        }
    },
    components: {
