...
export default {
    ...
    methods:{
        prepareSubtitles(){
            this.subtitles = [
                { title: 'Что такое подписание теста', mark: 'p5-st-1' },
                { title: 'Порядок подписание теста', mark: 'p5-st-2' },
                { title: 'Ошибки при подписании теста', mark: 'p5-st-3' },
                { title: 'Выгрузка подписанных тестов', mark: 'p5-st-4' }
            ]
        }
    },
    components: {
