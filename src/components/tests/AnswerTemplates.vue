...
export default {
    ...
    watch:{
        ...
        'answerCtx.uz_k'(){
            ...
            if(this.parseMode=='kiril-lotin' && this.showParse && this.showParse && this.testOptions.languagesSettings.languages.indexOf('uz_l')!=-1 && this.testOptions.languagesSettings.languages.indexOf('uz_k')!=-1){
